...
public class FabricaPersonal {
    public PersonalSpital crearePersonal(TipPersonal tipPersonal,String nume,int salariu)throws Exception{
        switch (tipPersonal){
            case MEDIC:
            ...
            case INFIRMIER:
                ...
                return infirmier;
            default:throw new Exception("Tipul nu este definit.");
        }
    }
}